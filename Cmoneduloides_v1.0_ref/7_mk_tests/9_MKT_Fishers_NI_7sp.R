...
mkt <- read.csv("/Users/verenakutschera/Dropbox/Projects/CrowCompGenomicsEBC/Cmoneduloides/MKT/mk_tests/mkt_table_pN_pS_noMultiStop_minDP3_maxMiss3_N_S_80_7sp_sorted_unique_180118_missingSetTo0.txt", sep="")
...
write.table(mkt_analysed2, "/Users/verenakutschera/Dropbox/Projects/CrowCompGenomicsEBC/Cmoneduloides/MKT/mk_tests/MKT_Fishers_NI_pN_pS_noMultiStop_minDP3_maxMiss3_N_S_80_7sp_sorted_unique_180118_missingSetTo0.txt", row.names = FALSE, quote=FALSE)
...
ggsave("/Users/verenakutschera/Dropbox/Projects/CrowCompGenomicsEBC/Cmoneduloides/MKT/mk_tests/Fishers_pvalues_pN_pS_noMultiStop_minDP3_maxMiss3_N_S_80_7sp_sorted_unique_180118_missingSetTo0.png",width= 11.5, height = 8, units = "cm")
...
ggplot(mkt_analysed2, aes(Fishers.p.value)) + geom_histogram(binwidth = 0.01) +
  ...
  geom_vline(xintercept=c(0.05), colour="red", linetype="dotted")+
  xlab("p values Fisher's exact test") + guides(fill=FALSE)
ggsave("/Users/verenakutschera/Dropbox/Projects/CrowCompGenomicsEBC/Cmoneduloides/MKT/mk_tests/Fishers_pvalues_lowFreq_pN_pS_noMultiStop_minDP3_maxMiss3_N_S_80_7sp_sorted_unique_180118_missingSetTo0.png",width= 11.5, height = 8, units = "cm")
...
ggsave("/Users/verenakutschera/Dropbox/Projects/CrowCompGenomicsEBC/Cmoneduloides/MKT/mk_tests/NI_pN_pS_noMultiStop_minDP3_maxMiss3_N_S_80_7sp_sorted_unique_180118_missingSetTo0.png",width= 11.5, height = 8, units = "cm") 
...
ggplot(mkt_analysed2, aes(NI, Fishers.p.value)) + geom_point() + 
  ...
  geom_vline(xintercept=c(1), colour="red", linetype="dotted")
ggsave("/Users/verenakutschera/Dropbox/Projects/CrowCompGenomicsEBC/Cmoneduloides/MKT/mk_tests/NI_vs_Fishers_pN_pS_noMultiStop_minDP3_maxMiss3_N_S_80_7sp_sorted_unique_180118_missingSetTo0.png",width= 11.5, height = 8, units = "cm")
...
ggplot(mkt_analysed2, aes(NI)) + geom_histogram(binwidth = 0.1) +
  ...
  geom_vline(xintercept=c(1), colour="red", linetype="dotted")
ggsave("/Users/verenakutschera/Dropbox/Projects/CrowCompGenomicsEBC/Cmoneduloides/MKT/mk_tests/NI_max20_pN_pS_noMultiStop_minDP3_maxMiss3_N_S_80_7sp_sorted_unique_180118_missingSetTo0.png",width= 11.5, height = 8, units = "cm")
...
ggplot(mkt_analysed2, aes(NI, Fishers.p.value)) + geom_point() +
  ...
  scale_x_continuous(limits = c(0,20), breaks = c(0,5,10,15,20))+
  geom_vline(xintercept=c(1), colour="red", linetype="dotted")
ggsave("/Users/verenakutschera/Dropbox/Projects/CrowCompGenomicsEBC/Cmoneduloides/MKT/mk_tests/NI_max20_vs_Fishers_pN_pS_noMultiStop_minDP3_maxMiss3_N_S_80_7sp_sorted_unique_180118_missingSetTo0.png",width= 11.5, height = 8, units = "cm")
