...
#########Usage#########
#cd cd /proj/b2013182/nobackup/POPseq/vcf/raw_bams/Cmoneduloides_v1
#for f in $(ls bwa_Ckub_Rota_21-23-1_S1_sorted.bam | grep Ckub | sed 's/.bam//g'); do sbatch /proj/b2013182/nobackup/batch_scripts/Cmon_Ref/mapping/step1.1_readgroup_fix.sh $f; done
...
#directories
raw_bams="/proj/b2013182/nobackup/POPseq/vcf/raw_bams/Cmoneduloides_v1"
proc_bams="/proj/b2013182/nobackup/PHYLO/Cmoneduloides_v1/processed_bams"

#lookup table for read group ids. Bam file name without file extension. 16-04-18: includes 5 C. moneduloides and 5 C. woodfordi individuals. Renamed lanes according to flow cell ids used.
table="/proj/b2013182/nobackup/batch_scripts/Cmon_Ref/gatk/Read_group_info_all.list"
